...
| `S03` | `desktop_qt_ui/ui/main_page/pages/settings_page.py`、`desktop_qt_ui/ui/main_page/dynamic_settings.py`、`desktop_qt_ui/ui/main_page/settings_tab_layout.json`、`desktop_qt_ui/core/config_models.py`、`desktop_qt_ui/app_logic.py`、`research/default-sources.md`、`phase0-ui-parameter-fields.json`、`research/phase0-options-i18n-matrix.md` |
