...
打开编辑器后，左侧默认显示“属性编辑”。在“图像编辑”分组中有“蒙版”“画笔”“印章”三个页签，每个页签提供一组互斥工具按钮；三个页签共用一个按钮组，因此选中任一页签的工具都会取消其他页签的工具选中。
...
```mermaid
flowchart LR
    S["选择（默认工具）"] -->|"属性面板按钮 / Q / W / E"| B["蒙版画笔 / 橡皮擦"]
    S -->|"画笔页签按钮"| P["彩色画笔 / 彩色画笔擦除"]
    S -->|"印章页签按钮"| C["仿制印章 / 印章擦除"]
